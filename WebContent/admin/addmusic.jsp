...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>音乐管理 <span class="c-gray en">&gt;</span> 新增音乐 <a
			class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="music/createMusic.action" title="刷新"><i
			class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="music/addMusic.action" name="myform" method="post">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">音乐名称</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="musicname" class="input-text" id="musicname" placeholder="请输入音乐名称" />
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<script type="text/javascript" src="js/selimage.js"></script>
					<input class="input-text" type="text" name="fileurl" id="fileurl" onclick="selfile();" placeholder="请选择音乐文件" readonly="readonly" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">歌手</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="singer" class="input-text" id="singer" placeholder="请输入歌手" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">专辑</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="album" class="input-text" id="album" placeholder="请输入专辑" />
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					...
					<textarea class="textarea" name="contents" id="contents" placeholder="请输入音乐详情"> </textarea>
