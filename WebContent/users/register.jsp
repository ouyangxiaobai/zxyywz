								...
								<table width="60%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
									...
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><input name="birthday" type="text" size="25" class="inputBg" id="birthday"
											onclick="WdatePicker()" readonly="readonly" placeholder="请输入出生日期" /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><input type="text" size="25" class="inputBg" name="image" id="image"
											onclick="selimage();" placeholder="请选择图片" readonly="readonly" /></td>
									</tr>
									<tr>
										<td colspan="2" align="center" bgcolor="#FFFFFF"><input type="submit" class="bnt_blue_1" style="border: none;" value="确认注册"
											id="sub" /></td>
									</tr>
								</table>
							</form>
