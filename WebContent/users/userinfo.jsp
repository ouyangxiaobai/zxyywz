							...
							<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input type="radio" name="sex" value="男" title="男" id="sex"
										${users.sex == "男"?"checked":""} />男&nbsp;&nbsp;&nbsp;<input type="radio" name="sex" value="女" title="女" id="sex"
										${users.sex == "女"?"checked":""} />女</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input type="text" size="25" class="inputBg" name="image" id="image"
										onclick="selimage();" value="${sessionScope.users.image }" readonly="readonly" /></td>
								</tr>
								<tr>
